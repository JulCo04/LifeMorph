  ...
  return (
    <div>
      ...
      <div className="fixed top-0 inset-x-0 bg-white h-14 flex items-center z-10 shadow-md">
        ...
        <span className="text-3xl">LifeMorph</span>
        <div className="ml-auto mr-5">
          <Link
            to="/login"
            className="text-xl hover:bg-gray-100 px-2 py-1 rounded-md"
          >
            Log in
          </Link>
        </div>
      ...
      <div className="mt-10 flex flex-col h-screen items-center">
        <div className=" h-max w-max m-5 p-5 text-center">
          <h1 className="mb-4 text-6xl font-bold">
            Manage your adult life effortlessly
          </h1>
          <span className="mb-4 text-2xl">
            Effortlessly manage your budget, track spending and goals, <br />
            stay organized with to-do lists and contact management, <br />
            and secure your passwords—all in one place.
          </span>

        </div>
        <div className=" h-max w-max text-center">
          <span className="mb-4 text-xl">
            Ready to get organized? Enter your email to create your account.
          </span>
          ...
          <input
            ...
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 p-2.5 outline-none"
          ...
          <div className="mt-5">
            <img
              ...
              className="w-fit h-[30rem] rounded-md"
